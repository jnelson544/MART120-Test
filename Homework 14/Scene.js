...
function setup()
{
    ...
    for (var i= 0; i < 3; i++){
        villianXspeed[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 5)) + 1);
        villianYspeed[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 5)) + 1);
        villianXs[i] = pickRandomNumber(500);
        villianYs[i] = pickRandomNumber(600);
        villianDMs[i] = pickRandomNumber(30); 
    }
...
function draw()
{
    ...
    for (var i = 0; i< villianXs.length; i++) {
        ellipse(villianXs[i], villianYs[i], villianDMs[i], villianDMs[i]);
        villianXspeed[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 5)) + 1);
        villianYspeed[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 5)) + 1);
    
        villianXs[i] += villianXspeed[i];
        villianYs[i] += villianYspeed[i];
...
function pickRandomNumber(number) {
